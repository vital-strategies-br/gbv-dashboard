...
// Types
import { NeighborhoodData, RelativeCategory } from "./types";
// Utils
...
function MapView() {
  ...
  let [hoveredNeighborhood, setHoveredNeighborhood] = useState<number | null>(
    null
  );
  let [highlightedCategory, setHighlightedCategory] =
    useState<RelativeCategory | null>(null);
              ...
              <SVGMap
                ...
                onPathMouseEnter={(id) => {
                  ...
                  setHighlightedCategory(
                    filteredDataById[id]?.category || null
                  );
                }}
                onMapMouseLeave={() => {
          ...
          <div className="mapview-section">
            <div className="mapview-instructions-wrapper">
              <span className="mapview-instructions">
                ...
                10.000 usuárias da atenção básica (AB) em cada bairro. O gráfico
                de barras agrupa bairros em faixas de estimativa similares. Ao
                passar o mouse sobre cada barra, destacam-se os bairros com
                quantidades similares de possíveis casos de violência não
                identificados pelo sistema de saúde para aquelas localidades.
              </span>
            </div>
